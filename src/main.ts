...
document.addEventListener('DOMContentLoaded', () => {
  ...
  app.innerHTML = `
    ...
    <main>
      ...
      <!-- Section Autres Pays — CTA Africa -->
      <section class="py-14 bg-gradient-to-br from-green-700 via-emerald-700 to-teal-800 text-white">
        <div class="max-w-4xl mx-auto px-4 text-center">
          <div class="text-5xl mb-4">🌍</div>
          <h2 class="text-2xl md:text-3xl font-bold mb-3">Vous envoyez dans un autre pays africain ?</h2>
          <p class="text-green-100 text-sm md:text-base mb-3 max-w-xl mx-auto">
            Notre service couvre <strong>14 pays africains</strong> — Côte d'Ivoire, Sénégal, Mali, Burkina Faso,
            Bénin, Niger, Togo, Guinée-Bissau, Gabon, Congo-Kinshasa, Nigeria, Ghana et plus.
          </p>
          <p class="text-green-200 text-xs mb-8">
            MTN · Orange · Wave · Moov · Airtel · Vodacom · Glo · AirtelTigo · Togocom disponibles
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="africa.html"
               class="inline-flex items-center justify-center gap-2 bg-white text-green-800 font-bold
                      py-3 px-8 rounded-xl shadow-lg hover:bg-green-50 transition-all text-base">
              🌍 Voir tous les pays Africa →
            </a>
            <a href="https://wa.me/306973598677" target="_blank"
               class="inline-flex items-center justify-center gap-2 bg-green-900/60 hover:bg-green-900
                      text-white font-semibold py-3 px-8 rounded-xl transition-all text-sm border border-white/20">
